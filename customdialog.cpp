...
int CustomDialog::addLineEdit(QString caption, std::string *stringValue, QString tooltip, bool isPassword)
{
  ...
  if (isPassword) {
      e.lineEdit->setEchoMode(QLineEdit::Password);
  }
                               ...
                               QString tooltip, QString tooltipArr, bool checkable, bool *checked)
{
  ...
  QStringList items = barSepList.split(
      "|",Qt::SkipEmptyParts);   // Break apart string values between each "|".
